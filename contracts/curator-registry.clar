;; curator-registry
;; This contract manages the curation, validation, and market inclusion of assets
;; on the Stacks blockchain. It provides a decentralized mechanism for community-driven
;; asset selection, reputation-based voting, and transparent market-making processes.
;; The contract facilitates a collaborative and permissionless asset management protocol.
;; Error Constants
